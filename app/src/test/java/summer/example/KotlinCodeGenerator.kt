...
class KotlinCodeGenerator {
    ...
    fun generate() {
        ...
        val outFile = File("./src/test/java/${pkg.replace(".", "/")}/$caseName.kt")
        if (!outFile.exists()) {
